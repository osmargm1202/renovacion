...
def calculate_area(area: dict, rules: dict) -> dict:
    """
    ...
    if people is None:
        ...
        people_method = {
            ...
            "trace_structured": trace_people_structured(
                people, caudal_target, result_people
            ),
        }
    ...
    return {
        ...
        "methods": {"rh": rh_method, "people": people_method},
